...
### Variables
#############################################################################################
$htmlfile = "\\localhost\c$\temp\file.html" ### The full path to the final HTML file
$htmlfile_temp = "\\localhost\c$\temp\file.html" ### The full path to the temporary HTML file
